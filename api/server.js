...
app.use(cors({
    origin:['https://dash-board-ajfj.vercel.app'],
    methods:['GET', 'POST','PUT','DELETE'],
  credentials:true
}));
...
app.get("/api/badAPI", function(req, res, next) {
...
app.get("/api/contactAPI", function(req, res, next) {
    // res.send("you are doing right job")
    Contact.find({})
    .then(data => {
        res.send(data);
  ...
  app.get("/api/feedAPI", function(req, res, next) {
      // res.send("you are doing right job")
      FeedBack.find({})
      .then(data => {
          res.send(data);
    ...
    app.get("/api/goodAPI", function(req, res, next) {
        // res.send("you are doing right job")
        //   good responce
            goodResponse.find({})
            .then(data => {
      ...
      app.get("/api/studentAPI", function(req, res, next) {
          // res.send("you are doing right job")
...
app.post("/api/testAPI", (req, res, next) => {
  try{
...
app.delete("/api/testAPI", (req, res, next) => {
  // res.send({data:req.body.id});
...
app.get("/api/testAPI", (req, res, next) => {
  try{
...
app.get("/api/WebrichAPI", (req, res, next) => {
  count.find({})
...
app.get("/api/wrongAPI", function(req, res, next) {
  // res.send("you are doing right job")
  //   good responce
      wrongAnswer.find({})
      .then(data => {
