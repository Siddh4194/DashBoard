...
export default function Chatbar(props) {
    ...
    useEffect(()=>{
        fetch(`${process.env.REACT_APP_API_URL}/studentAPI`)
        .then(response => response.json())
        .then(data => setStudent(data))
    },[]);
    useEffect(()=>{
        fetch(`${process.env.REACT_APP_API_URL}/badAPI`)
        .then(response => response.json())
        .then(data => setBad(data))
    },[]);
    useEffect(()=>{
        fetch(`${process.env.REACT_APP_API_URL}/goodAPI`)
        .then(response => response.json())
        .then(data => setGood(data))
    },[]);
    useEffect(()=>{
        fetch(`${process.env.REACT_APP_API_URL}/feedAPI`)
        .then(response => response.json())
        .then(data => setFeed(data))
    },[]);
    useEffect(()=>{
        fetch(`${process.env.REACT_APP_API_URL}/wrongAPI`)
        .then(response => response.json())
